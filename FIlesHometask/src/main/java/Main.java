...
public class Main {
    public static void main(String[] args) {
        ...
        //Можно прописать пути в программе изначально, но у каждог разные названия папок и файлов, а создание файлов не даст возможности что-то в них записать до окончания работы программы(т.к пока программа работает, то файлы не считаются созданными)
    }
}
